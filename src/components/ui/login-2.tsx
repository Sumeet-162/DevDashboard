      ...
      <div className="flex flex-1 flex-col justify-center px-4 py-10 lg:px-6">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          ...
          <p className="mt-2 text-base text-muted-foreground">
            ...
            <span className="font-semibold text-primary">GitHub</span> and{" "}
            <span className="font-semibold text-primary">LeetCode</span> progress,
            and stay updated with the latest{" "}
            <span className="font-semibold text-primary">tech news</span>.
          </p>
